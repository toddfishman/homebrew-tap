# Generated for v0.6.2 by packaging/renderformula.sh in toddfishman/stowit.
...
class Stowit < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "8c58a44aa1005970f0c57250551c69987eb667ec8cb90fd9af7832207e1ed116"
    end
    on_intel do
      url "https://github.com/toddfishman/stowit-releases/releases/download/v#{version}/stowit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "b0b7087e8e09bcf4b58ecb1d0cb0bf2fc80fff8331ea96332c4a641f10f970a8"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "22ab27c32a256b1789d8b614bb23b6f265a6ebd1d5fd541e241f8b1059f71269"
    end
    on_intel do
      ...
      sha256 "ec5639a85435cf99e6a992d9336009b96725a5b05fb498dba2345e2831c2f467"
    end
  end
