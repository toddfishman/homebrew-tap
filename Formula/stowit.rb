# Generated for v0.4.0 by packaging/renderformula.sh in toddfishman/stowit.
...
class Stowit < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "699795715025893cdb03af3dc9f7baece7d4e33c0434e8d129e2e1e432921a69"
    end
    on_intel do
      url "https://github.com/toddfishman/stowit-releases/releases/download/v#{version}/stowit-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "c2a9a548d1cf0016f4ee707fbefb761dce656034956b0b76b712d5586b9b78bc"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "e4e0b94a597e2de114c8a4571ab9ce00e0f9468a2ff619d57295697ad4600f2d"
    end
    on_intel do
      ...
      sha256 "bcf7dd1d2f70f30822d59a7d6e49d0d4d653d0b7a331251ba95bfb4e34b0bbf0"
    end
  end
